...
- **Not Just HTML**: Provides built in [handlers for common data formats](https://jpt.sh/projects/spatula/reference/#pages) including CSV, JSON, XML, PDF, and Excel.  Or write your own.
...
- **CLI Tools**: Offers several [CLI utilities](https://jpt.sh/projects/spatula/cli/) that can help streamline development & testing cycle.
